...
- **Settings**: Polished the Settings page with Large Titles, consistent headers, and a **sticky footer** for version info that remains visible at the bottom of the screen.
